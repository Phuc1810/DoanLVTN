...
class StoreTourRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'SoCho' => [Rule::requiredIf(fn() => $this->input('LoaiTour') === 'Cá nhân'), 'nullable', 'integer', 'min:1'],
            ...
            'NgayKhoiHanh' => ['nullable', Rule::requiredIf(fn() => $this->input('LoaiTour') === 'Cá nhân' && $this->input('TinhChatTour') === 'Theo đợt'), 'date', 'after:today'],
